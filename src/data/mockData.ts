...
export const authors: Author[] = [
  {
    ...
    avatar:
      "https://images.pexels.com/photos/762080/pexels-photo-762080.jpeg?auto=compress&cs=tinysrgb&w=200",
...
export const mockArticles: Article[] = [
  {
    id: "1",
    title:
      "Les négociations climatiques de la COP28 atteignent un tournant décisif",
    excerpt:
      "Les délégations mondiales se rapprochent d'un accord historique sur la transition énergétique...",
    content: "",
    ...
    likes: 342,
    imageUrl:
      "https://images.pexels.com/photos/9324300/pexels-photo-9324300.jpeg?auto=compress&cs=tinysrgb&w=800",
  ...
  },
  {
    ...
    excerpt:
      "Une nouvelle génération d'outils IA promet de transformer le diagnostic médical...",
    content: "",
  ...
  },
  {
    ...
    excerpt:
      "La décision de maintenir les taux d'intérêt influence les indices boursiers...",
    content: "",
  ...
  },
  {
    id: "4",
    title:
      "Championnat du Monde de Football : Les qualifications s'intensifient",
    excerpt:
      "Les équipes nationales se battent pour décrocher leur billet vers la compétition...",
    content: "",
  ...
  },
  {
    ...
    excerpt:
      "Les outils d'intelligence artificielle révolutionnent la création de contenu, du design graphique à la production musicale...",
    content: "",
    category: categories[3],
    author: authors[2],
  ...
  },
  {
    ...
    excerpt:
      "Les experts en sécurité se préparent à l'ère post-quantique avec de nouveaux protocoles de chiffrement...",
    content: "",
    category: categories[3],
    author: authors[2],
  ...
  },
  {
    ...
    excerpt:
      "L'écosystème tech français bat tous les records avec plus de 8 milliards d'euros levés au premier trimestre...",
    content: "",
    category: categories[3],
    author: authors[2],
