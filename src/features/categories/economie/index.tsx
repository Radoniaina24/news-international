...
export default function ArticlesPolitique() {
  ...
  const isLoadingState = isLoading
    ...
    : data?.posts.map((post: WPBlogPost) => (
        <BlogCard category="Économie" key={post.id} article={post} />
      ));
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      ...
      <header className="relative bg-white shadow-xl border-b border-gray-100 overflow-hidden">
        {/* Background Pattern économique */}
        <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/5 via-blue-600/5 to-slate-700/5"></div>
        <div
          className="absolute inset-0 opacity-30"
          style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23000000' fill-opacity='0.03'%3E%3Cpath d='M20 20h20v20H20z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
          }}
        ></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 relative">
          <div className="text-center mb-12">
            ...
            <h1 className="text-xl font-bold text-gray-900 mb-4 leading-tight">
              ...
              <br />
              <span className="text-gray-800">Analyse et Perspectives</span>
            </h1>

            <p className="text-md text-gray-700 max-w-4xl mx-auto leading-relaxed mb-8">
              Décryptages experts des marchés financiers, indicateurs
              économiques et tendances macroéconomiques. Comprenez les
              mécanismes qui régissent la croissance et influencez les décisions
              stratégiques.
            </p>
          </div>
        </div>
              ...
              <div className="flex items-center justify-between">
                {isLoading ? (
                  ...
                  <StatCard
                    ...
                    singular={"article économique"}
                    plural={"articles économiques"}
                  />
                )}
              </div>
            </div>
